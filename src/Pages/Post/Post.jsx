...
import { getPostByIdOne, getUserById, reportPost, addPostLike, getComment, postComment } from '../../service/api';
            ...
            {/* <p className={`post-post-caption ${props.darkmode?"changeModeP":""}`} style={{marginTop:'10px', cursor:'auto'}}>{post?.text}</p>
                ...
                <div className="post-mainpost-below">
                        ...
                        <div className="post-mainpost-below-right">
                            ...
                            {
                                user?._id === post?.user ? '' : <button className='mainbar-mainpost-share-button'><ShareIcon style={{fontSize:'20px'}} /></button>
                            }
                        </div>
                </div>
